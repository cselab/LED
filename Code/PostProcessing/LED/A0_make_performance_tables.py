...
for system_name in [
    ...
    test_result_file = \
    [
    # "results_dimred_testing_val",
    # "results_dimred_testing_test",
    # "results_autoencoder_testing_train",
    "results_autoencoder_testing_val",
    "results_autoencoder_testing_test",
    ]
    ...
    # COLUMNS_TO_SORT = [2, 3, 4]
    # DESCENTINGS = [False, True, False]
