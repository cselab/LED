...
# |     10 | 0.000176645 |     0.357546 | GPU-ARNN-scaler_MinMaxZeroOne-OPT_adabelief-LR_0.001-NL_0.0-L2_0.0-RS_30-CHANNELS_1-16-32-64-8-KERNELS_5-5-5-5-BN_0-TRANS_0-POOL_avg-ACT_celu-DKP_1.0-LD_8  |
...
# hyper_params_dict["iterative_loss_schedule_and_gradient"] = ["none", "inverse_sigmoidal_with_gradient"]
# hyper_params_dict["iterative_loss_schedule_and_gradient"] = ["inverse_sigmoidal_with_gradient"]
hyper_params_dict["iterative_loss_schedule_and_gradient"] = ["none"]
...
hyper_params_dict["overfitting_patience"]       = [40]
hyper_params_dict["sequence_length"]            = [50]
hyper_params_dict["n_warmup"]                   = [60]
hyper_params_dict["retrain"]                    = [0]
hyper_params_dict["train_RNN_only"]             = [1]
hyper_params_dict["load_trained_AE"]            = [1]
...
hyper_params_dict["RNN_cell_type"]              = ["lstm"]
hyper_params_dict["RNN_layers_num"]             = [1]
hyper_params_dict["RNN_layers_size"]            = [512]
hyper_params_dict["RNN_activation_str_output"]  = ["tanhplus"]
...
multiscale_macro_steps_list=[0, 4, 8, 16, 32, 64, 128, 256]

hyper_params_dict["prediction_horizon"]         = [200]
hyper_params_dict["num_test_ICS"]               = [100]

plot_multiscale_results_comparison=0
max_jobs_per_run = len(hyper_params_dict["multiscale_micro_steps"])
...
# hyper_params_dictionary_list[0]["plotting"]     = 1
# hyper_params_dictionary_list[0]["prediction_horizon"]     = 500
# hyper_params_dictionary_list[0]["test_on_test"]     = 1
# hyper_params_dictionary_list[0]["test_on_val"]     = 0
# max_jobs_per_run = 1


# GPU-ARNN-scaler_MinMaxZeroOne-OPT_adabelief-LR_0.001-NL_0.0-L2_0.0-RS_10-CHANNELS_1-16-32-64-8-KERNELS_5-5-5-5-BN_0-TRANS_1-POOL_avg-ACT_celu-DKP_1.0-LD_6-PRETRAIN-AE_1-RS_7-C_lstm-R_1x128-SL_25-LFO_0-LFL_1
    ...
    for run_num in range(num_runs):
        with open("./Tasks/P0_B{:}_greasy_AE_RNN_tasks.txt".format(run_num + 1),
            ...
            for dict_num in range(run_num * max_jobs_per_run,
                ...
                if hyper_param_dict_case["iterative_loss_schedule_and_gradient"] != "none":
                    hyper_param_dict_case["iterative_loss_validation"] = 1
