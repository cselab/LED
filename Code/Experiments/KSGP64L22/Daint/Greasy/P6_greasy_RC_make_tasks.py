...
hyper_params_dict["rc_approx_reservoir_size"]   = [2000, 8000]
...
""" Removing arguments not needed for Reservoir Computers """
...
# hyper_params_dictionary_list[0]["truncate_timesteps"]     = 600
...
if not IS_MULTISCALE_TESTING:
    for run_num in range(num_runs):
        with open("./Tasks/P6_B{:}_greasy_RC_tasks.txt".format(run_num + 1),
                  "w") as file:
