...
# # |      1 | 1.18603 |  0.109665 | 0.303146 | GPU-CNN-SINDy-scaler_MinMaxZeroOne-OPT_adabelief-LR_0.001-NL_0.0-L2_0.0-RS_10-CHANNELS_1-16-32-64-8-KERNELS_5-5-5-5-BN_0-TRANS_1-POOL_avg-ACT_celu-DKP_1.0-LD_8-TYPE_continuous-PO_3-THRES_0.0001-LIB_poly-INT_5             |

# hyper_params_dict["latent_state_dim"]           = [8]

# hyper_params_dict["sindy_integrator_type"]      = ["continuous"]
# hyper_params_dict["sindy_degree"]               = [3]
# hyper_params_dict["sindy_threshold"]            = [0.0001]
# hyper_params_dict["sindy_library"]              = ["poly"]
...
# hyper_params_dictionary_list[0]["truncate_timesteps"]     = 200
