...
# |     11 | 6.75985e-07 | GPU-ARNN-scaler_MinMaxZeroOne-OPT_adabelief-LR_0.001-NL_0.0-L2_0.0-RS_10-CHANNELS_2-8-16-32-4-KERNELS_5-5-5-5-BN_0-TRANS_1-POOL_avg-ACT_celu-DKP_1.0-LD_4   |
...
# |     22 | 0.0184197  | GPU-ARNN-scaler_MinMaxZeroOne-OPT_adabelief-LR_0.001-NL_0.0-L2_0.0-RS_7-AUTO_3x100-ACT_celu-DKP_1.0-LD_2-C_lstm-R_1x32-SL_20-LFO_1-LFL_1                                                                                    |
hyper_params_dict["overfitting_patience"]       = [20]
hyper_params_dict["sequence_length"]            = [20]
hyper_params_dict["n_warmup"]                   = [20]
hyper_params_dict["retrain"]                    = [0]
""" END2END TRAINING """
hyper_params_dict["train_RNN_only"]             = [0]
...
multiscale_macro_steps_list=[0, 10, 50, 100, 200, 1000, 9000]
