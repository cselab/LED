...
# hyper_params_dict["multiscale_macro_steps"] = [20]
# hyper_params_dict["multiscale_micro_steps"] = [4]
...
for i in range(len(hyp_dict_list)):
    if hyp_dict_list[i]["system_name"] == "cylRe100HR":
        ...
        hyp_dict_list[i]["RNN_layers_size"]             = 32
        ...
        # hyp_dict_list[i]["random_seed"]             = 17 # tested only for one IC / need to re-test
        # WRONG RESULTS FOR: GPU-ARNN-SC_MinMaxZeroOne-OPT_adabelief-PREC_single-LR_0.001-NL_0.0-L2_0.0-RS_10-CNL_4-20-20-20-20-20-2-KRN_13-13-13-13-13-13-BN_1-TR_1-SI_2-PL_avg-ACT_celu-DKP_1.0-LD_10-PRETRAIN-AE_1-RS_21-C_lstm-R_1x32-SL_10-LFO_0-LFL_1
...
for run_num in range(num_runs):
    with open("./Tasks/MA2P1_B{:}_greasy_AECNN_RNN_tasks.txt".format(run_num + 1),
              "w") as file:
