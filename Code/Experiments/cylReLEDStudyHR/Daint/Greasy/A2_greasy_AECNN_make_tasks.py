...
#     if (hyp_dict_list[i]["system_name"]=="cylRe1000HR") and hyp_dict_list[i]["latent_state_dim"]==10:
#         idx2rem = i

# if idx2rem is not None:
#     print("Removing index {:}".format(idx2rem))
#     del hyp_dict_list[idx2rem]
...
for run_num in range(num_runs):
    with open("./Tasks/A2_B{:}_greasy_AECNN_tasks.txt".format(run_num + 1),
              "w") as file:
