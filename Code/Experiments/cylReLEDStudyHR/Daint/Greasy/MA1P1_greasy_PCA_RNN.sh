...
#SBATCH --output=/scratch/snx3000/pvlachas/STF/Code/Results/cylReLEDStudyHR/Logs/cylStudy_MA1P1_greasy_PCA_RNN_outputfile_JID%j_A%a.txt
#SBATCH --error=/scratch/snx3000/pvlachas/STF/Code/Results/cylReLEDStudyHR/Logs/cylStudy_MA1P1_greasy_PCA_RNN_errorfile_JID%j_A%a.txt
...
export GREASY_LOGFILE="/scratch/snx3000/pvlachas/STF/Code/Results/cylReLEDStudyHR/Logs/cylStudy_MA1P1_B"$1"_greasy_PCA_RNN_logfile_JID"${SLURM_JOBID}".txt"
