...
hyper_params_dict["rc_approx_reservoir_size"]   = [200]
...
# hyp_dict_list[0]["rc_dynamics_length"]     = 2
# hyp_dict_list[0]["test_on_test"]     = 1
# hyp_dict_list[0]["test_on_val"]     = 1
# hyp_dict_list[0]["latent_state_dim"]     = 10
# hyp_dict_list[0]["system_name"]     = "cylRe1000HR"
...
for run_num in range(num_runs):
    with open("./Tasks/A2P2_B{:}_greasy_AECNN_RC_tasks.txt".format(run_num + 1),
              "w") as file:
